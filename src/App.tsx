...
// ─── Logo (fiel al proporcionado por el usuario) ──────────────────────────────
function CoroNyxLogo({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
      <defs>
        <linearGradient id="app-lg-main" x1="10" y1="10" x2="90" y2="90" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#5FC9BE"/>
          <stop offset="50%" stopColor="#1E8C82"/>
          <stop offset="100%" stopColor="#0B3D3A"/>
        </linearGradient>
        <linearGradient id="app-lg-tooth" x1="35" y1="28" x2="65" y2="78" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#7DD9D3"/>
          <stop offset="100%" stopColor="#1E8C82"/>
        </linearGradient>
      </defs>
      <path d="M72 14 A38 38 0 1 0 72 86" stroke="url(#app-lg-main)" strokeWidth="7" strokeLinecap="round" fill="none"/>
      ...
      <path d="M50 30 C42 30 36 36 36 44 L37.5 63 C37.8 66 39.5 67.5 42 67.5 C44.5 67.5 46 65.5 50 65.5 C54 65.5 55.5 67.5 58 67.5 C60.5 67.5 62.2 66 62.5 63 L64 44 C64 36 58 30 50 30 Z" fill="url(#app-lg-tooth)" opacity="0.95"/>
